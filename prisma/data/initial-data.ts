...
import { ValidTypes } from '../../src/interfaces';
...
type SeedCategory = 'men' | 'women' | 'kid' | 'unisex';
type SeedSize = 'XS' | 'S' | 'M' | 'L' | 'XL' | 'XXL' | 'XXXL';
type SeedType = 'shirts' | 'pants' | 'hoodies' | 'hats';
...
export const initialData: SeedData = {
  ...
  products: [
    ...
    {
      description:
        'Designed for comfort and style in any Seedsize, the Tesla Small Wordmark Tee is made from 100% Peruvian cotton and features a 3D silicone-printed wordmark on the left chest.',
